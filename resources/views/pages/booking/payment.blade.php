							...
							<div class="booking-form">
								...
								<form class="#">
									<div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="booking-info pay-amount">
                                                {{-- <h6>Do you want to hire a driver?</h6> --}}
                                                <div class="radio radio-btn">
                                                    <label>
                                                        <h5 lass="text-warning"> <input type="radio" name="radio">  Paymaya</h5>
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <h5 class="text-info"> <input type="radio" name="radio">  Gcash</h5>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
									...
									<div class="payment-btn">
                                        ...
                                        <button class="btn btn-success submit-review w-50" type="button"  data-bs-toggle="modal" data-bs-target="#pages_edit">Pay $315</button>
									</div>
								</form>
							</div>
						</div>
					...
					<div class="modal-body">
						<div class="payment-success">
							...
							<p>You Payment has been successfully done.
                                <br><span class="text-danger">Please Check your email for the invoice</span><br>
								Trasaction id :<span> #5064164454</span>
							</p>
							<div class="order-confirm">
								<a href="{{url('/')}}">Go to Order Confirmation<i class="fa-solid fa-arrow-right ms-2"></i></a>
							</div>
						</div>
