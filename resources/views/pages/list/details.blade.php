                        ...
                        <div class="detail-product">
                            <div class="slider detail-bigimg">
                                <div class="product-img">
                                    <img src="{{url('assets/img/cars/slider-01.jpg')}}" alt="Slider">
                                </div>
                                <div class="product-img">
                                    <img src="{{url('assets/img/cars/slider-02.jpg')}}" alt="Slider">
                                </div>
                                <div class="product-img">
                                    ...
                                    <div class="listing-item pb-0">
                                        <div class="listing-img">
                                            <a href="listing-details.html">
                                                <img src="{{url('assets/img/cars/car-02.jpg')}}" class="img-fluid" alt="KIA">
                                            </a>
                                            <div class="fav-item">
				...
				<div class="modal-dialog modal-dialog-centered modal-md">
					<div class="modal-content">
                                ...
                                <div class="col-md-12">
                                    <div class="booking-info pay-amount">
                                        ...
                                        <div class="radio radio-btn">
                                            <label>
                                                <input type="radio" name="radio"> Yes, we want to hire.
                                            </label>
                                        </div>
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="radio"> No, we don't need.
                                            </label>
                                        </div>
                                    </div>
                                </div>
						...
						<div class="modal-footer">
							<a href="{{url('booking/payment')}}" class="btn btn-back">Go to Details<i class="fa-solid fa-arrow-right"></i></a>
						</div>
					</div>
				</div>
			</div>
